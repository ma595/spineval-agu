...
### Spinup-evaluation (1)
- {{< fa chart-line >}} Computes metrics on `raw` emulator outputs, instantaneous (`restart`) and time averaged (`grid`) output files 
...
- Basic  a validation gate; does grid encoding and sanity checks (existence of `NaNs` etc)
