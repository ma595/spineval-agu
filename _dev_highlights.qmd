## Evaluation-Benchmark {auto-animate=true}
...
- How do we evaluate hybrid ocean emulators?
  ...
  - PILLAR 3: 
    - Sample from distribution of possible states
- Pillars 1, 2 and 3 are enabled with the use of two software components:
:::
