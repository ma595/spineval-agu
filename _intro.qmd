...
::: {.box-row .fragment data-fragment-index="0" style="top: 0; justify-content: left;"}
...
<svg class="fragment" data-fragment-index="1" style="position: absolute; top: 85px; right: 85px; width: 40px; height: 330px; z-index: 1;" viewBox="0 0 40 300">
...
::: {.box-row .fragment data-fragment-index="1" style="bottom: -40px; justify-content: flex-end;"}
::: {.label style="text-align: right;"}
...
::: {.box-row .fragment data-fragment-index="2" style="top: 55%; transform: translateY(-50%);"}
...
graph TD
  ...
  %% Applying explicit styles to prevent theme clashing
    classDef default fill:#1a365d,stroke:#fff,stroke-width:2px,color:#fff;
    classDef highlight fill:#84BD00,stroke:#fff,stroke-width:2px,color:#fff;
    classDef bridge fill:#003E51,stroke:#fff,stroke-width:2px,color:#fff;
